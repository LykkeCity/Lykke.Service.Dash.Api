    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                {
                    options.DefaultLykkeConfiguration("v1", "DashApi API");
                });
                ...
                services.AddSingleton<Lykke.Service.Dash.Api.Settings.AppSettings>(appSettings.CurrentValue);

                services.AddLykkeLogging(
                    appSettings.ConnectionString(x => x.DashApiService.Db.LogsConnString),
                    "DashApiLog",
